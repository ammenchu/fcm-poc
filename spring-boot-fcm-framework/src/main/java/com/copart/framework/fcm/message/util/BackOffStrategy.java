...
public class BackOffStrategy {
	...
	/**
	 * Use this method when the call was successful otherwise it will continue in an
	 * infinite loop
	 */
	...
	/**
	 * Reset back off state. Call this method after successful attempts if you want
	 * to reuse the class.
	 */
	public void reset() {
		this.numberOfTriesLeft = numberOfRetries;
